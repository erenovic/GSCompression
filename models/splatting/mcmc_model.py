...
"""This module contains the GaussianModel class which is adapted from the 3D-MCMC codebase."""
...
class GaussianModel:
    ...
    def restore(self, model_args: Namespace, training_args: Namespace | None):
    ...
    def densify_and_split(
        ...
        are large in screen space. Used during adaptive densification. (Not used for 3D-MCMC)
    ...
    def densify_and_clone(self, grads: torch.Tensor, grad_threshold: float, scene_extent: float):
        ...
        are small in screen space. Used during adaptive densification. (Not used for 3D-MCMC)
    ...
    def densify_and_prune(
        self, max_grad: float, min_opacity: float, extent: float, max_screen_size: float
    ):
