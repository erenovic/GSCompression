...
"""This module contains the GaussianModel class which is the base model for the Gaussian 
primitives. This code is adapted from the original codebase and is the most basic form of 
Gaussian primitives.
"""
...
class GaussianModel:
    ...
    def restore(self, model_args: Namespace, training_args: Namespace):
    ...
    def densification_postfix(
        ...
        Args:
            ...
            new_features_rest (torch.Tensor): The new rest of the features of the Gaussian primitives.
