...
do
    ...
    # --model_path ./output/mcmc_compress/$scene_name/eb_0.005_from25k \
    ...
    --model_path ./output/mcmc_compress/$scene_name/ms_0.000001_from25k_freeze \
    --model mcmc --cap_max $capmax \
