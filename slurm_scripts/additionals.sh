...
# "mipnerf360/bicycle" "mipnerf360/bonsai" "mipnerf360/counter" \
    ...
    # "mipnerf360/room" 
scene_names=("mipnerf360/bicycle")
...
do
    ...
    # Mean scale hyperprior from 30k (lmbda 0.001)
    python train_compression.py --scene_name $scene_name \
    --config ./config/preset_configs/mcmc_gaussian.yaml \
    --model_path ./output/mcmc_compress/$scene_name/ms_from30k \
    --model mcmc --cap_max $capmax \
    ...
    # Entropy bottleneck from 30k (lmbda 0.0001)
    python train_compression.py --scene_name $scene_name \
    --config ./config/preset_configs/mcmc_compress.yaml \
    --model_path ./output/mcmc_compress/$scene_name/eb_0.0001_from30k \
    --model mcmc --cap_max $capmax \
    --compressor entropybottleneck \
    --extra_iterations 10000 \
    --checkpoint ./output/mcmc_radsplat/$scene_name/checkpoints/chkpnt30000.pth
    ...
    python train_compression.py --scene_name $scene_name \
    --config ./config/preset_configs/mcmc_compress.yaml \
    --model_path ./output/mcmc_compress/$scene_name/ms_0.0001_from30k \
    --model mcmc --cap_max $capmax \
    --compressor meanscale \
    --extra_iterations 10000 \
    --checkpoint ./output/mcmc_radsplat/$scene_name/checkpoints/chkpnt30000.pth
    ...
    # --model_path ./output/mcmc_compress/$scene_name/eb_multirate_from30k \
    # --model mcmc --cap_max $capmax \
    # --compressor entropybottleneck \
    # --extra_iterations 10000 \
    # --checkpoint ./output/mcmc_radsplat/$scene_name/checkpoints/chkpnt30000.pth
    ...
    # python train_compression.py --scene_name $scene_name \
    # --config ./config/preset_configs/mcmc_multirate_gaussian.yaml \
    # --model_path ./output/mcmc_compress/$scene_name/ms_multirate_from30k \
    # --model mcmc --cap_max $capmax \
    # --compressor meanscale \
    # --extra_iterations 10000 \
    # --checkpoint ./output/mcmc_radsplat/$scene_name/checkpoints/chkpnt30000.pth
    ...
    # # Radsplat MCMC
    # python train.py --scene_name $scene_name \
    #     --config ./config/preset_configs/mcmc_gaussian.yaml \
